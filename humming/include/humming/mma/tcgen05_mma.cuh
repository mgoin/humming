...
public:
  ...
  // (track-e bc431ed + track-f round 3) to the un-fenced/un-awaited
  // TMA-C epilogue read of smem.reduce -- fixed in gmem_writer.cuh +
  // the kernels -- so the closed form is now enabled everywhere.
